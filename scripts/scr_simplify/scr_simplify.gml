 ...
 * @return {Array}
 */
function geometry_simplify(_points,_epsilon=undefined){
...
/*
	...
	animcurve_point_add(simple_point_list,_points[_end].posx	,_points[_end].value)*/
		...
		{
			var _d = pointToLineDistance(	_points[_i][0]		,_points[_i][1],
											_points[_start][0]	,_points[_start][1],
											_points[_end][0]	,_points[_end][1])
			_avgDist += _d
